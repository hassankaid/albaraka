// ⚠️ ANCIEN onglet Marketing, conservé le temps que la V2 soit validée.
//
// La V2 (`MarketingTab.tsx`) couvre la performance par conférence, la
// performance mensuelle avec objectifs, et l'analyse par canal / tunnel /
// combinaison. Elle ne reprend PAS le suivi des RDV ni les drill-downs
// détaillés qui vivent ici — c'est pour ça que ce fichier n'est pas supprimé.
//
// À jeter dès que ces écrans auront été soit repris dans la V2, soit déclarés
// inutiles. Ne rien construire de neuf dessus.
...
export default function MarketingTabLegacy({ filter: externalFilter, onFilterChange }: MarketingTabProps = {}) {
