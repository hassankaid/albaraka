// ─────────────────────────────────────────────────────────────────────────
// Page de confirmation de prise de rendez-vous — PARTAGÉE par les tunnels qui
// se terminent sur un agenda (VSL, Liberty).
//
// Atteinte après réservation, via la REDIRECTION Calendly (à configurer côté
// Calendly : Confirmation Page → Redirect to an external site → l'URL de
// confirmation du tunnel, avec « pass event details to your redirect » activé).
//
