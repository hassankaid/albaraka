/**
 * Contrat Liberty — tarif conférence 4 000 € (réduction 1 000€).
 * Wording exact : /CONTRAT_LIBERTY_4000_CONFERENCE.txt
 *
 * Identique à Liberty standard sauf le bloc "Ton investissement" (prix
 * barré 5000 → 4000) et la mention du montant total dans l'article
 * "Paiement" des conditions importantes (4000 au lieu de 5000).
 */
...
export function ContractLibertyConference({ data }: Props) {
  return (
    <ContractPage title={`Contrat ALB-LIB-${data.contractNumber}`}>
      ...
      <Section title="Ton investissement">
        <InvestmentBlock
          ...
          amountOriginal={data.amountOriginal || 5000}
