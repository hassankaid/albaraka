...
const STEPS = [
  ...
  },
  {
    ...
    body: "La plateforme te guidera pas à pas dans ton PASS LIBERTY.",
  },
];

export default function MerciLibertyPage() {
    ...
    >
      ...
      <div style={{ maxWidth: 440, margin: "0 auto", position: "relative", zIndex: 2 }}>
        ...
        <div className="alb-fade-2" style={{ textAlign: "center", marginBottom: 30 }}>
          ...
          >
            Félicitations pour ce choix courageux. Tu fais désormais partie de la famille PASS LIBERTY.
          </p>
        </div>
