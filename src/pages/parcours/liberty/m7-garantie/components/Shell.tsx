...
export function Shell({
  ...
  upstreamForced, m7Forced, signed,
}: ShellProps) {
  return (
    <div
    ...
    >
      <div className="mx-auto w-full max-w-[860px] px-4 py-8 md:py-10">
        ...
        {upstreamForced && (
          ...
          >
            ⚠ <strong>Stratégie M4/M5/M6 forcée en amont</strong> — le seuil de validation M7 est monté à <strong>85/100</strong> (au lieu de 80) sur toutes les étapes pédagogiques.
          </div>
        )}
        {m7Forced && !upstreamForced && (
          <div
            className="mb-3 rounded-xl px-4 py-2 text-[12px] leading-[1.5]"
            style={{
          ...
          >
            ⚠ Une ou plusieurs étapes M7 ont été <strong>forcées</strong> — l'audit IA en a tenu compte dans le handoff M8.
          </div>
        )}
        {signed && (
          <div
          ...
          >
            ✓ <strong>M7 signé et verrouillé</strong> — les modifications sont désactivées.
          </div>
        )}
