...
export function Shell({
  ...
  upstreamForced, m5Forced, signed,
}: ShellProps) {
  return (
    <div
    ...
    >
      <div className="mx-auto w-full max-w-[860px] px-4 py-8 md:py-10">
        ...
        {/* Bannière forced upstream M4 — permanente si M4 a été forcé */}
        {upstreamForced && (
          <div
          ...
          >
            ⚠ <strong>Stratégie M4 forcée</strong> — le seuil de validation M5 est monté à <strong>85/100</strong> (au lieu de 80) pour compenser la faiblesse upstream.
          </div>
        )}
        {m5Forced && !upstreamForced && (
          <div
            className="mb-3 rounded-xl px-4 py-2 text-[12px] leading-[1.5]"
            style={{
              background: "rgba(255,180,80,0.06)",
          ...
          >
            ⚠ Une ou plusieurs étapes M5 ont été <strong>forcées</strong> — l'audit IA en a tenu compte dans le handoff M6.
          </div>
        )}
        {signed && (
          <div
          ...
          >
            ✓ <strong>M5 signé et verrouillé</strong> — les modifications sont désactivées.
          </div>
        )}
