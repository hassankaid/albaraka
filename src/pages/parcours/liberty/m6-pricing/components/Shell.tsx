...
export function Shell({
  children, onRestart, demoLabel, onExitDemo,
  upstreamForced, m6Forced, signed,
}: ShellProps) {
  return (
    <div
    ...
    >
      <div className="mx-auto w-full max-w-[860px] px-4 py-8 md:py-10">
        ...
        {upstreamForced && (
          ...
          >
            ⚠ <strong>Stratégie M4/M5 forcée en amont</strong> — le seuil de validation M6 est monté à <strong>85/100</strong> (au lieu de 80) sur toutes les étapes pédagogiques pour compenser la faiblesse upstream.
          </div>
        )}
        {m6Forced && !upstreamForced && (
          <div
            className="mb-3 rounded-xl px-4 py-2 text-[12px] leading-[1.5]"
            style={{
              background: "rgba(201,76,76,0.08)",
              border: "0.5px solid #c94c4c",
              color: "#e8a0a0",
            }}
          >
            ⚠ Une ou plusieurs étapes M6 ont été <strong>forcées</strong> — l'audit IA en a tenu compte dans le handoff M7.
          </div>
        )}
        {signed && (
          <div
            ...
            style={{
              ...
              border: "0.5px solid #4cc987",
              color: "#b0e8c5",
            }}
          >
            ✓ <strong>M6 signé et verrouillé</strong> — les modifications sont désactivées.
          </div>
        )}
