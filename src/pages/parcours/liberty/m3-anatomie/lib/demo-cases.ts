...
const REMISE_FORME_PATCH: Partial<M3State> = {
  ...
  garantie: { type: "performance", formulation: "Si après les 12 semaines de programme suivies à 80% (séances faites + photos hebdo + alimentation suivie) tu n'as pas perdu au moins 5 kg, je te prolonge l'accès gratuitement pendant 60 jours et je t'accompagne en 1to1 jusqu'à atteindre l'objectif.", score: 86, attempts: 2, validated: true, forced: false, feedback: { verdict: "✓ Performance avec conditions actives (80% suivi · photos · alim) — pas une garantie passive." }, history: [] },
